...
![First Boot & Authentication Trap Handling](Images/First-Boot-&-Authentication-Trap-Handling.png)
...
![Rename the Server and Restart](Images/Rename-the-Server-and-Restart.png)
...
![Configure a Static IPv4 Address](Images/Configure-a-Static-IPv4-Address.png)
...
![Launch the Add Roles and Features Wizard](Images/Launch-the-Add-Roles-and-Features-Wizard.png)
...
![Select Roles](Images/Select-Roles.png)
...
![Confirm and Install](Images/Confirm-and-Install.png)
...
![Initiate the Promotion Wizard](Images/Initiate-the-Promotion-Wizard.png)
...
![Domain Controller Options & DSRM Password](Images/Domain-Controller-Options-&-DSRM-Password.png)
...
![Additional Options and Path Verification](Images/Additional-Options-and-Path-Verification.png)
...
![Prerequisite Check and Final Promotion](Images/Prerequisite-Check-and-Final-Promotion.png)
...
![Access Active Directory Users and Computers (ADUC)](Images/Access-Active-Directory-Users-and-Computers-(ADUC).png)
...
![Create a Departmental Organizational Unit (OU)](Images/Create-a-Departmental-Organizational-Unit-(OU).png)
...
![Provision a New User Account](Images/Provision-a-New-User-Account.png)
...
![Create a Department Security Group](Images/Create-a-Department-Security-Group.png)
...
![Add Users to the Security Group](Images/Add-Users-to-the-Security-Group.png)
...
![Configure Shared Folder NTFS Permissions](Images/Configure-Shared-Folder-NTFS-Permissions.png)
...
![Verify DNS Integration and Record Registration](Images/Verify-DNS-Integration-and-Record-Registration.png)
...
![Configure DHCP Scope Parameters](Images/Configure-DHCP-Scope-Parameters.png)
...
![Access Group Policy Management Console (GPMC)](Images/Access-Group-Policy-Management-Console-(GPMC).png)
...
![Create and Link a New GPO](Images/Create-and-Link-a-New-GPO.png)
...
![Edit Policy Settings (Enforcing Configuration Standards)](Images/Edit-Policy-Settings-(Enforcing-Configuration-Standards).png)
